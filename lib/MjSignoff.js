  ...
  _createClass(MjSignoff, [{
    ...
    value: function renderText() {
      ...
      if (this.getAttribute('closing')) {
        textContent += "<p class=\"signoff__closing\">".concat(this.getAttribute('closing'), "</p>");
      }

      if (this.getAttribute('name')) {
        textContent += "<p class=\"signoff__name\">".concat(this.getAttribute('name'), "</p>");
      }

      if (this.getAttribute('title')) {
        textContent += "<p class=\"signoff__title\">".concat(this.getAttribute('title'), "</p>");
      }

      if (this.getAttribute('title2')) {
        textContent += "<p class=\"signoff__title2\">".concat(this.getAttribute('title2'), "</p>");
      }

      if (this.getAttribute('title3')) {
        textContent += "<p class=\"signoff__title3\">".concat(this.getAttribute('title3'), "</p>");
      }
